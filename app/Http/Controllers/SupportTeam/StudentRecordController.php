    ...
    public function store(StudentRecordCreate $req)
    {
       ...
       /* $ct = ($ct == 'J') ? 'JSS' : $ct;
        ...
        if ($req->hasFile('photo')) {
            ...
            // Fayl nomini saqlash uchun to'liq yo'l
            $full_path = 'site/images/student/' . $image_name;
            $file->move(public_path('site/images/student/'), $image_name);
            // Fayl nomini so'rov ma'lumotlariga qo'shish
            $d['photo'] = $full_path;
        }
